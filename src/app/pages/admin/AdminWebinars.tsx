...
export default function AdminWebinars() {
  ...
  async function handleAddSection() {
    ...
    await createWebinarSection({ slug: slugify(newSectionTitle), title: newSectionTitle, sortOrder: sections.length });
    setNewSectionTitle('');
    refreshSections();
  }
